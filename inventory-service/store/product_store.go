...
func (s *MongoProductStore) Create(ctx context.Context, product *models.Product) error {
...
func (s *MongoProductStore) Update(ctx context.Context, id string, product *models.Product) error {
	objID, err := primitive.ObjectIDFromHex(id)
	if err != nil {
...
func (s *MongoProductStore) List(ctx context.Context, filter bson.M, limit, offset int64) ([]*models.Product, int64, error) {
