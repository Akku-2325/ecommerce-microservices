...
func (s *MongoOrderStore) Create(ctx context.Context, order *models.Order) error {
...
func (s *MongoOrderStore) GetByID(ctx context.Context, id string) (*models.Order, error) {
...
func (s *MongoOrderStore) UpdateStatus(ctx context.Context, id string, status models.OrderStatus) error {
	objID, err := primitive.ObjectIDFromHex(id)
	if err != nil {
...
func (s *MongoOrderStore) ListByUserID(ctx context.Context, userID string, limit, offset int64) ([]*models.Order, int64, error) {
